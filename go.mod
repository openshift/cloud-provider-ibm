...
require (
	cloud.ibm.com/cloud-provider-vpc-controller v0.4.0
...
replace cloud.ibm.com/cloud-provider-vpc-controller v0.4.0 => github.com/IBM-Cloud/cloud-provider-vpc-controller v0.4.0
